...
$body->startBody('accounts', 'LMENUL131', 'Employee Institute Contribution Formulae');
...
<div id="content_header">
    ...
    <div id="contentHeader">Institute Contribution Formuale Setup</div>
</div>
<div class="clear"></div>
<div id="choiceListing">
    ...
    <form id="allowanceForm" class="allowanceForm" onsubmit="return valid.validateForm(this) ? processAllowanceForm() : false;">    
        <fieldset class="formelements">
            <div class="legend">
                <span>Select Fund For Formaule Setup</span>
            </div>
            <dl class="element">
                <dt style="width: 15%"><label for="allowance">Allowance Name :</label>	</dt>
                <dd style="width: 30%">
                    <select class="required" name="allowance" id="allowance" style="width: 200px" onchange="javascript: valid.validateInput(this);">
                    </select>
        ...
        <fieldset class="action buttons">
            ...
            <button type="submit" name="submit" id="submit" class="positive insert" accesskey="I">Set Fund Formulae</button>
        </fieldset>
   	</form>     
    </div>
</div>
