...
$body->startBody('accounts', 'LMENUL155', 'Consolidated Slip Printing');
    ...
    <form id="allowanceForm" class="allowanceForm" onsubmit="return valid.validateForm(this) ? processAllowanceForm() : false;">    
        <fieldset class="formelements buttons">
            ...
            <dl class="element">
                ...
                <dd style="width: 25%">
                	<button type="button" style="width: 250px; text-align: left" class="positive insert" onclick="printConsolidatedSlip()">Print Consolidated Slip</button></dd>                                 
            </dl>
        </fieldset>
   	</form>     
    </div>
