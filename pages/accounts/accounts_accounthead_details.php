...
$body = new body ();
$body->startBody ( 'accounts', 'LMENUL109', 'Account Head Name Details' );
?>
<div id="content_header">
    ...
    <div id="contentHeader">Account Head Details</div>
</div>
<div class="clear"></div>
...
<div class="inputs">
    <form id="insertForm" class="insertForm" onsubmit="return valid.validateForm(this) ? processInsertForm() : false;">
        <fieldset class="formelements">
            <div class="legend">
                <span>New Account Type Entry Form</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    <select name="accountType" id="accountType" class="required"  title="select the type of account"  tabindex="2" onchange="javascript: valid.validateInput(this);">
                    	<option value="c">Credit</option>
                    	<option value="d">Debit</option>
                    </select>
                    <div id="accountTypeError" class="validationError"	style="display: none"></div>
                </dd>
                <dt style="width: 15%">
                    <label for="displayOrder">Display Order :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="displayOrder" id="displayOrder" class="required numeric"  title="enter the display order"  tabindex="3" size="20" onchange="javascript: valid.validateInput(this);" />
...
<div class="inputs">
    <form id="updateForm" class="updateForm" onsubmit="return valid.validateForm(this) ? processUpdateForm() : false;" style="display:none">
        <fieldset class="formelements">
            <div class="legend">
                <span id="legend_editForm">Account Head Record Update Form</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
            ...
            <dl class="element">
                <dt style="width: 15%">
                    <label for="accountType_u">Type :</label>
                </dt>
                <dd style="width: 30%">
                    <select name="accountType_u" id="accountType_u" class="required"  title="select the type of account"  tabindex="2" onchange="javascript: valid.validateInput(this);">
                    	<option value="c">Credit</option>
                    	<option value="d">Debit</option>
                    </select>
                    <div id="accountTypeError_u" class="validationError"	style="display: none"></div>
                </dd>
                <dt style="width: 15%">
                    <label for="displayOrder_u">Display Order :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="displayOrder_u" id="displayOrder_u" class="required numeric"  title="enter the display order"  tabindex="3" size="20" onchange="javascript: valid.validateInput(this);" />
...
<div class="inputs">
    <form id="searchForm" class="searchForm" onsubmit="return getSearchResults()">
        <fieldset class="formelements">
            ...
            <dl>
                <dt style="width: 15%">
                <label for="hint">Account Head</label>
                </dt>
                <dd style="width: 30%">
...
<div class="datatable buttons" id="displayDatatable" style="display:none">
    <fieldset class="formelements">
        <div class="legend">
            <span>Tabulated Listing Of All Account Head</span>
        </div>
        <table  class="display"
               id="groupRecords">
            <thead>
