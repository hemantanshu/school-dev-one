...
$body = new body ();
$options = new options ();
$body->startBody ( 'utility', 'LMENUL34', 'Candidate Education Details Entry Page' );

$candidateId = $_GET ['candidateId'];
?>
<div id="content_header">
    <div id="pageButton" class="buttons">
        <button type="button" class="regular toggle" onclick="showHidePersonalForm()"><span class="underline">T</span>oggle Personal Data</button>
    ...
    <div id="contentHeader">Candidate Education Details Entry Page</div>
</div>

<input type="hidden" name="candidateId"
	value="<?php echo $candidateId; ?>" id="candidateId" />
<input type="hidden" name="popupUrl"
	value="<?php echo BASE_PATH.$candidateId; ?>" id="candidateId" />	
<div class="clear"></div>
<div class="display">
				...
				<dd style="width: 80%">
					<span style="float: left"><input type="hidden" name="institute_val" id="institute_val"
                                 value="" /> <input type="text" name="institute" id="institute"
                                                    class="required autocomplete" tabindex="1" size="40"
                                                    onchange="javascript: valid.validateInput(this);"
                                                    title="Select The Institute Name" /></span>
...
<div class="inputs">
	<form id="updateForm" class="updateForm"
		onsubmit="return processUpdateForm()" style="display: none">
		<fieldset class="formelements">
			<div class="legend">
			...
			<dl class="element">
				...
				<dd style="width: 80%">
					<span style="float: left"><input type="hidden" name="institute_uval" id="institute_uval"
                                                     value="" /> <input type="text" name="institute_u" id="institute_u"
                                                                        class="required autocomplete" tabindex="6" size="40"
                                                                        onchange="javascript: valid.validateInput(this);"
                                                                        title="Select The Institute Name" /></span>
					<span style="float: left; padding-left: 20px;">
                        <button type="button" class="negative insert" onclick="addNewInstitute()" style="padding: 0 5px 2px 5px">Add New Institute</button></span>
...
<div class="inputs">
	<form id="searchForm" class="searchForm"
		onsubmit="return valid.validateForm(this) ? getSearchDetails() : false;" style="display: nosne">
		<fieldset class="formelements">
...
<div class="datatable buttons" id="displayDatatable" style="display: none">
	<fieldset class="tableElements">
		<div class="legend">
			<span>Total Education History Listing</span>
		</div>
		<table  class="display"
			id="groupRecord">
			<thead>
