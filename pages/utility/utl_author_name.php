...
$body = new body ();
$body->startBody ( 'global', 'LMENUL9', 'Author Entry Page', 'LMENUL15' );
?>
<div id="content_header">
    ...
    <div id="contentHeader">Book Author Record Details Form</div>
</div>
<input type="hidden" value="ATHOR" name="optionType_glb"
	id="optionType_glb" />
<div class="inputs">
	<form id="insertForm" class="insertForm"
		...
		<fieldset class="formelements">
			<div class="legend">
				<span>New Author Record Entry Form</span>
			</div>
			<dl class="element">
				<dt style="width: 15%">
					<label for="valueName">Author Name :</label>
				</dt>
				<dd style="width: 35%">
...
<div class="inputs">
	<form id="updateForm" class="updateForm"
		...
		<fieldset class="formelements">
			<div class="legend">
				<span id="legend_updateForm">Author Record Update Form </span>
			</div>
			<dl class="element">
				<dt style="width: 15%">

					<label for="valueName_u">Author Name :</label>
				</dt>
				<dd style="width: 35%">
...
<div class="display">
	<div id="displayValue">
		<fieldset class="displayElements">
			<div class="legend">
				<span id="legendDisplayAssignment">Author Details : </span>
			</div>
			<dl>
				<dt style="width: 15%">
					<label for="optionId">Author Id : </label>
				</dt>
				<dd style="width: 30%">
			...
			<dl>
				<dt style="width: 15%;">
					<label for="valueName_d">Author Name : </label>
				</dt>
				<dd style="width: 30%">
...
<div class="inputs">
	<form id="searchForm" class="searchForm"
		...
		<fieldset class="formelements">
			<div class="legend">Search Author Name</div>
			<dl>
				<dt style="width: 15%">
					<label for="menu_hint">Author Name :</label>
				</dt>
				<dd style="width: 30%">
					<input type="text" name="menu_hint" id="menu_hint" class=""
						style="width: 200px" title="Enter The Author Name" />
				</dd>
				<dt style="width: 10%">
				...
				<dd>
					<select name="search_type" id="search_type" style="width: 150px">
						...
						<option value="1" selected="selected">Active Author</option>
						<option value="0">In-Active Author</option>
					</select>
				</dd>
			</dl>
		</fieldset>
...
<div id="displayDatatable" class="buttons">
	<div class="datatable" id="groupMenusM">
		<fieldset>
			<div class="legend">
				<span>Author Record Tabulated Listing</span>
			</div>
			<table  class="display"
				id="groupValues">
				<thead>
