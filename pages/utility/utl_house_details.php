...
$body = new body();
$body->startBody('global', 'LMENUL9', 'House Entry Page', 'LMENUL26');
?>
<input type="hidden" value="HOUSE" name="optionType_glb" id="optionType_glb" />
<div id="content_header">
    ...
    <div id="contentHeader">House Record Details Form</div>
</div>
<div class="inputs">
    <form id="insertForm" class="insertForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span>New House Record Entry Form</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
                    <label for="valueName">House Name :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="inputs">
    <form id="updateForm" class="updateForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span id="legend_updateForm">House Record Update Form </span>
            </div>
            <dl class="element">
                <dt style="width: 15%">

                    <label for="valueName_u">House Name :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="display">
    <div id="displayValue">
        <fieldset class="displayElements">
            <div class="legend">
                <span id="legendDisplayAssignment">House Details : </span>
            </div>
            <dl>
                <dt style="width: 15%">
                    <label for="optionId">House Id : </label>
                </dt>
                <dd style="width: 30%">
            ...
            <dl>
                <dt style="width: 15%;">
                    <label for="valueName_d">House Name : </label>
                </dt>
                <dd style="width: 30%">
...
<div class="inputs">
    <form id="searchForm" class="searchForm"
        ...
        <fieldset class="formelements">
            <div class="legend">Search House Name</div>
            <dl>
                <dt style="width: 15%">
                    <label for="menu_hint">House Name :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="menu_hint" id="menu_hint" class=""
                           style="width: 200px" title="Enter The House Name" />
                </dd>
                <dt style="width: 10%">
                ...
                <dd>
                    <select name="search_type" id="search_type" style="width: 150px">
                        ...
                        <option value="1" selected="selected">Active House</option>
                        <option value="0">In-Active House</option>
                    </select>
                </dd>
            </dl>
        </fieldset>
...
<div id="displayDatatable" class="buttons">
    <div class="datatable" id="groupMenusM">
        <fieldset>
            <div class="legend">
                <span>House Record Tabluated Listing</span>
            </div>
            <table  class="display"
                   id="groupValues">
                <thead>
