...
$body = new body ();
$body->startBody ( 'utility', 'LMENUL63', 'Section Candidate Subject Assignment' );
...
<input type="hidden" name="section_global" id="section_global" value="<?php echo $sectionId; ?>" />
<div class="clear"></div>
<div class="display">
    <div id="sessionRecord" style="display: none">
        <fieldset class="displayElements">
            ...
            <dl>
                <dt style="width: 15%">
                    <label for="section_d">Section :</label>
                </dt>
                <dd style="width: 30%">
                    <span id="section_d"></span>
                </dd>
            </dl>
        </fieldset>
    </div>
