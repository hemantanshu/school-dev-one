...
$body->startBody ( 'utility', 'LMENUL64', 'Class Section Candidate Subject Bulk Assignment' );

$sectionId = $_GET ['sectionId'];
$sectionDetails = $body->getTableIdDetails($sectionId);
$classId = $sectionDetails['class_id'];
if ($sectionDetails['class_id'] == "" || !$session->isSessionEditable($sectionDetails['session_id']))
    exit(0);
    ...
    <div id="sessionRecord" style="display: none">
        <fieldset class="displayElements">
            ...
            <dl>
                ...
                <dd style="width: 30%">
                    <span id="section_d"><?php echo $sectionDetails['section_name'];?></span>
                </dd>
            </dl>
        </fieldset>
    </div>
        ...
        <fieldset>
            ...
            foreach ($candidateAssociationIds as $candidateAssociationId){
                ...
                echo "<dt style=\"width: 10%\">
        				<label for=\"registrationNumber\">".$registrationDetails['registration_number']."</label>	
        			</dt>
        			<dt style=\"width: 25%\">
...
<div id="extraMenuListingPage" style="display:none">
	...
	?>
	<li><a href="#" class="bookmarkedMenuListing" onclick="loadPageIntoDisplay('<?php echo $baseServer."pages/utility/utl_class_section_candidate_subject_view.php?sectionId=".$sectionId; ?>')"><img src="<?php echo $baseServer; ?>images/global/b_usredit.png" alt="" />Optional Subject View</a></li>
</div>