...
$body = new body ();
$body->startBody ( 'global', 'LMENUL9', 'Marking Scheme/Type', 'LMENUL33' );
?>
<input type="hidden" value="MSCHM" name="optionType_glb"
	id="optionType_glb" />
<div id="content_header">
    ...
    <div id="contentHeader">Scoring Type Record Details Form</div>
</div>
<div class="inputs">
    <form id="insertForm" class="insertForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span>New Scoring Record Entry Form</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
                    <label for="valueName">Scoring Type :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="inputs">
    <form id="updateForm" class="updateForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span id="legend_updateForm">Scoring Record Update Form </span>
            </div>
            <dl class="element">
                <dt style="width: 15%">

                    <label for="valueName_u">Scoring Type :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="display">
    <div id="displayValue">
        <fieldset class="displayElements">
            <div class="legend">
                <span id="legendDisplayAssignment">Scoring Details : </span>
            </div>
            <dl>
                <dt style="width: 15%">
                    <label for="optionId">Scoring Id : </label>
                </dt>
                <dd style="width: 30%">
            ...
            <dl>
                <dt style="width: 15%;">
                    <label for="valueName_d">Scoring Type : </label>
                </dt>
                <dd style="width: 30%">
...
<div class="inputs">
    <form id="searchForm" class="searchForm"
        ...
        <fieldset class="formelements">
            <div class="legend">Search Scoring Type</div>
            <dl>
                <dt style="width: 15%">
                    <label for="menu_hint">Scoring Type :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="menu_hint" id="menu_hint" class=""
                           style="width: 200px" title="Enter The Scoring Type" />
                </dd>
                <dt style="width: 10%">
                ...
                <dd>
                    <select name="search_type" id="search_type" style="width: 150px">
                        <option value="all">All Scorings</option>
                        <option value="1" selected="selected">Active Scoring</option>
                        <option value="0">In-Active Scoring</option>
                    </select>
                </dd>
            </dl>
        </fieldset>
...
<div id="displayDatatable" class="buttons">
    <div class="datatable" id="groupMenusM">
        <fieldset>
            <div class="legend">
                <span>Scoring Record Tabulated Listing</span>
            </div>
            <table  class="display"
                   id="groupValues">
                <thead>
