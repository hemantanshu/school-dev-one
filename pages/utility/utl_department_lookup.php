...
$body = new body();
$body->startBody('global', 'LMENUL9', 'Department Entry Page', 'LMENUL105');
?>
<input type="hidden" value="DEPTY" name="optionType_glb" id="optionType_glb" />
<div id="content_header">
    ...
    <div id="contentHeader">Institute Department Record Details Form</div>
</div>
<div class="clear"></div>
<div class="inputs">
    <form id="insertForm" class="insertForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span>New Department Record Entry Form</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
                    <label for="valueName">Department Name :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="inputs">
    <form id="updateForm" class="updateForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span id="legend_updateForm">Department Record Update Form </span>
            </div>
            <dl class="element">
                <dt style="width: 15%">

                    <label for="valueName_u">Department Name :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="display">
    <div id="displayValue">
        <fieldset class="displayElements">
            <div class="legend">
                <span id="legendDisplayAssignment">Department Details : </span>
            </div>
            <dl>
                <dt style="width: 15%">
                    <label for="optionId">Department Id : </label>
                </dt>
                <dd style="width: 30%">
            ...
            <dl>
                <dt style="width: 15%;">
                    <label for="valueName_d">Department Name : </label>
                </dt>
                <dd style="width: 30%">
...
<div class="inputs">
    <form id="searchForm" class="searchForm"
        ...
        <fieldset class="formelements">
            <div class="legend">Search Department Name</div>
            <dl>
                <dt style="width: 15%">
                    <label for="menu_hint">Department Name :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="menu_hint" id="menu_hint" class=""
                           style="width: 200px" title="Enter The Department Name" />
                </dd>
                <dt style="width: 10%">
                ...
                <dd>
                    <select name="search_type" id="search_type" style="width: 150px">
                        ...
                        <option value="1" selected="selected">Active Department</option>
                        <option value="0">In-Active Department</option>
                    </select>
                </dd>
            </dl>
        </fieldset>
...
<div id="displayDatatable" class="buttons">
    <div class="datatable" id="groupMenusM">
        <fieldset>
            <div class="legend">
                <span>Department Record Tabulated Listing</span>
            </div>
            <table  class="display"
                   id="groupValues">
                <thead>
