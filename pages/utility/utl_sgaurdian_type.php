...
$body = new body();
$body->startBody('global', 'LMENUL9', 'Staff Gaurdian Type Entry Page', 'LMENUL21');
?>
<input type="hidden" value="GAURS" name="optionType_glb" id="optionType_glb" />
<div id="content_header">
    ...
    <div id="contentHeader">Staff Guardian Type Record Details Form</div>
</div>
<div class="inputs">
