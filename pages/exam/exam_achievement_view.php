...
$body->startBody ( 'exam', 'LMENUL118', 'Candidate Achievement View' );
$resultId = $_GET['resultId'];
$sectionId = $_GET['sectionId'];
$sessionId = $_GET['sessionId'];

$resultDetails = $result->getTableIdDetails($resultId);
$resultSectionId = $junior->getResultJuniorId($resultId, $sectionId);
...
<div id="content_header">
    ...
    <div id="contentHeader">Achievement View For The Section</div>
</div>
<div class="clear"></div>
<div class="display">
        	...
        	<table width="100%" align="left" border = "0" class="buttons" id="mainTable">
                ...
                <?php 
                	...
                	foreach ($candidateIds as $candidateId){
                		...
                		$details = $result->getTableIdDetails($data[0]);
                		echo "
