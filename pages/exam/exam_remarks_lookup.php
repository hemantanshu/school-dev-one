...
$body = new body();
$body->startBody('global', 'LMENUL9', 'Remarks Lookup', 'LMENUL91');
?>
<input type="hidden" value="REMKS" name="optionType_glb" id="optionType_glb" />
<div id="content_header">
    ...
    <div id="contentHeader">Examination Remarks Lookup</div>
</div>
<div class="clear"></div>
<div class="inputs">
    <form id="insertForm" class="insertForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span>New Building Record Entry Form</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
                    <label for="valueName">Remarks Name :</label>
                </dt>
                <dd style="width: 35%">
                    <textarea name="valueName" id="valueName" class="required"
                           title="Enter The New Value" onchange="javascript: valid.validateInput(this);" value="" rows="2" cols="50"></textarea>
...
<div class="inputs">
    <form id="updateForm" class="updateForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span id="legend_updateForm">Remarks Record Update Form </span>
            </div>
            <dl class="element">
                <dt style="width: 15%">

                    <label for="valueName_u">Remarks Name :</label>
                </dt>
                <dd style="width: 35%">
                    <textarea name="valueName_u" id="valueName_u"
...
<div class="display">
    <div id="displayValue">
        <fieldset class="displayElements">
            <div class="legend">
                <span id="legendDisplayAssignment">Remarks Details : </span>
            </div>
            <dl>
                <dt style="width: 15%">
                    <label for="optionId">Remarks Id : </label>
                </dt>
                <dd style="width: 30%">
            ...
            <dl>
                <dt style="width: 15%;">
                    <label for="valueName_d">Remarks Name : </label>
                </dt>
                <dd style="width: 30%">
...
<div class="inputs">
    <form id="searchForm" class="searchForm"
        ...
        <fieldset class="formelements">
            <div class="legend">Search Remarks Name</div>
            <dl>
                <dt style="width: 15%">
                    <label for="menu_hint">Remarks Name :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="menu_hint" id="menu_hint" class=""
                           style="width: 200px" title="Enter The Remarks Name" />
                </dd>
                <dt style="width: 10%">
                ...
                <dd>
                    <select name="search_type" id="search_type" style="width: 150px">
                        <option value="all">All Remarkss</option>
                        <option value="1" selected="selected">Active Remarks</option>
                        <option value="0">In-Active Remarks</option>
                    </select>
                </dd>
            </dl>
        </fieldset>
...
<div id="displayDatatable" class="buttons">
    <div class="datatable" id="groupMenusM">
        <fieldset>
            <div class="legend">
                <span>Remarks Record Tabulated Listing</span>
            </div>
            <table  class="display"
                   id="groupValues">
                <thead>
                <tr>
                    <th style="width: 80px">Remarks Id</th>
                    <th>Remarks Name</th>
