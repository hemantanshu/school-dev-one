        ...
        <fieldset class="formelements">
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    ...
                    <input type="text" name="markSubmissionOfficer_u" id="markSubmissionOfficer_u" class="required"  title="Assign Mark Submission Task To Some Officer" tabindex="109" value="" size="30" onchange="javascript: valid.validateInput(this);" />
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    ...
                    <input type="text" name="markVerificationOfficer_u" id="markVerificationOfficer_u" class="required"  title="Assign Mark Verification Task To Some Officer" tabindex="111" value="" size="30" onchange="javascript: valid.validateInput(this);" />
