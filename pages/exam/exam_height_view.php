...
$body->startBody ( 'exam', 'LMENUL116', 'Candidate Height View' );
...
<div id="content_header">
    ...
    <div id="contentHeader">Height View For The Section</div>
</div>
<div class="clear"></div>
<div class="display">
        	...
        	<table width="100%" align="left" border = "0" class="buttons" id="mainTable">
                ...
                <?php 
                	...
                	foreach ($candidateIds as $candidateId){
                		...
                		$data = $result->getCandidateData($resultSectionId, $candidateId, 'HIGHT');
