...
$body = new body ();
$body->startBody ( 'exam', 'LMENUL152', 'Exam Datasheet Subject Component Grade Setup' );
...
<div id="content_header">
    ...
    <div id="contentHeader">Exam Datasheet Subject Component Grade Setup </div>
</div>
<div class="clear"></div>
<div class="display">
        ...
        <dl>        	
        	<table width="100%" align="left" border = "0" class="buttons">
                <tr class="even">
                    ...
                    <th>Grade Type</th>
                    <th style="width: 210px">Submit</th>
                </tr>
                <tr>
                	<td colspan="7"><hr /></td>
                </tr>  
                	...
                	foreach ($subjectComponents as $subjectComponentDetails){
                		...
                		echo "
			                    ...
			                    <th align=\"center\">
									...
									<button type=\"button\" class=\"positive browse\" onclick=\"processSubmitAction('".$i."')\">Submit Datasheet Grade</th>			                    
			                </tr>";
                		++$i;
					}
