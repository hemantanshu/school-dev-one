...
$body = new body ();
$body->startBody ( 'exam', 'LMENUL113', 'Junior Result Class Setup' );
    ...
    <form id="insertForm" class="insertForm" onsubmit="return valid.validateForm(this) ? processInsertForm() : false;"  style="display: none">
        <fieldset class="formelements">
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    <input type="text" name="weightDate" id="weightDate" class="required"  title="weight date "  tabindex="4" size="20" onchange="javascript: valid.validateInput(this);" />
                    <div id="weightDateError" class="validationError"	style="display: none"></div>
                </dd>
                <dt style="width: 15%">
                    <label for="weightOfficer">Weight Officer :</label>
                </dt>
                <dd style="width: 30%">
                	<input type="hidden" name="weightOfficer_val" id="weightOfficer_val" value="" />
                    <input type="text" name="weightOfficer" id="weightOfficer" class="required autocomplete"  title="officer to be assigned"  tabindex="5" size="30" onchange="javascript: valid.validateInput(this);" />
                    <div id="weightOfficer_valError" class="validationError"	style="display: none"></div>
                </dd>
            </dl>    
            <dl class="element">
                <dt style="width: 15%">
                    <label for="heightDate">Height Date :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="heightDate" id="heightDate" class="required"  title="height date "  tabindex="4" size="20" onchange="javascript: valid.validateInput(this);" />
                    <div id="heightDateError" class="validationError"	style="display: none"></div>
                </dd>
                <dt style="width: 15%">
                    <label for="heightOfficer">Height Officer :</label>
                </dt>
                <dd style="width: 30%">
                	<input type="hidden" name="heightOfficer_val" id="heightOfficer_val" value="" />
                    <input type="text" name="heightOfficer" id="heightOfficer" class="required autocomplete"  title="officer to be assigned"  tabindex="5" size="30" onchange="javascript: valid.validateInput(this);" />
                    <div id="heightOfficer_valError" class="validationError"	style="display: none"></div>
                </dd>
            </dl>    
            <dl class="element">
                <dt style="width: 15%">
                ...
                <dd style="width: 30%">
                    <input type="text" name="achievementDate" id="achievementDate" class="required"  title="achievement date "  tabindex="4" size="20" onchange="javascript: valid.validateInput(this);" />
                    <div id="achievementDateError" class="validationError"	style="display: none"></div>
                </dd>
                <dt style="width: 15%">
                    <label for="achievementOfficer">Achievement Officer :</label>
                </dt>
                <dd style="width: 30%">
                	<input type="hidden" name="achievementOfficer_val" id="achievementOfficer_val" value="" />
                    <input type="text" name="achievementOfficer" id="achievementOfficer" class="required autocomplete"  title="officer to be assigned"  tabindex="5" size="30" onchange="javascript: valid.validateInput(this);" />
                    <div id="achievementOfficer_valError" class="validationError"	style="display: none"></div>
                </dd>
            </dl>    
    ...
    <div id="displayValue">
        <fieldset class="displayElements">
            ...
            <dl>
                ...
                <dt style="width: 15%">
                    <label for="attendanceSubmissionDisplay">Attendance Officer :</label>
                </dt>
                <dd style="width: 30%">
            ...
            <dl>
                ...
                <dt style="width: 15%">
                    <label for="remarksSubmissionDisplay">Remarks Officer :</label>
                </dt>
                <dd style="width: 30%">
            ...
            <dl>
                <dt style="width: 15%;">
                    <label for="weightDateDisplay">Weight Date :</label>
                </dt>
                <dd style="width: 30%">
                    <span id="weightDateDisplay"></span>
                </dd>
                <dt style="width: 15%">
                    <label for="weightSubmissionDisplay">Weight Officer :</label>
                </dt>
                <dd style="width: 30%">
                    <span id="weightSubmissionDisplay"></span>
                </dd>
            </dl>
            <dl>
                <dt style="width: 15%;">
                    <label for="heightDateDisplay">Height Date :</label>
                </dt>
                <dd style="width: 30%">
                    <span id="heightDateDisplay"></span>
                </dd>
                <dt style="width: 15%">
                    <label for="heightSubmissionDisplay">Height Officer :</label>
                </dt>
                <dd style="width: 30%">
                    <span id="heightSubmissionDisplay"></span>
                </dd>
            </dl>
            <dl>
                <dt style="width: 15%;">
                    <label for="achievementDateDisplay">Achievement Date :</label>
                </dt>
                <dd style="width: 30%">
                    <span id="achievementDateDisplay"></span>
                </dd>
                <dt style="width: 15%">
                    <label for="achievementSubmissionDisplay">Achievement Officer :</label>
                </dt>
                <dd style="width: 30%">
                    <span id="achievementSubmissionDisplay"></span>
                </dd>
            </dl>
            <dl>
                <dt style="width: 15%;">
