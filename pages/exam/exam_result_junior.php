        ...
        <fieldset class="formelements">
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    ...
                    <input type="text" name="weightOfficer" id="weightOfficer" class="required autocomplete"  title="officer to be assigned"  tabindex="5" size="40" onchange="javascript: valid.validateInput(this);" />
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    ...
                    <input type="text" name="heightOfficer" id="heightOfficer" class="required autocomplete"  title="officer to be assigned"  tabindex="5" size="40" onchange="javascript: valid.validateInput(this);" />
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    ...
                    <input type="text" name="achievementOfficer" id="achievementOfficer" class="required autocomplete"  title="officer to be assigned"  tabindex="5" size="40" onchange="javascript: valid.validateInput(this);" />
