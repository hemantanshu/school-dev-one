...
$body->startBody ( 'exam', 'LMENUL119', 'Result Candidate Achievement Submission' );
...
$enteredCandidates = $result->getCandidate4Data($resultSectionId, 'ACHIV');
...
<div id="content_header">
    ...
    <div id="contentHeader">Achievement Entry For The Section</div>
</div>
<div class="clear"></div>
<div class="display">
        	...
        	<table width="100%" align="left" border = "0" class="buttons" id="mainTable">
                ...
                <?php 
                	...
                	foreach ($candidateIds as $candidateId){
                		...
                		$data = $result->getCandidateData($resultSectionId, $candidateId, 'ACHIV');               		
                		echo "
                			<tr class=\"odd\" id=\"$tableId\">
			                    <th>".$registration->getCandidateRegistrationNumber($candidateId)."</th>
			                    <th>".$personalInfo->getUserName()."</th>	
			                    <th><textarea id=\"".$markId."\" tabindex=\"$i\" name=\"".$markId."\" cols=\"60\" rows=\"2\">".$data[1]."</textarea></th>
