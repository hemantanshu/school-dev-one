...
$body->startBody ( 'exam', 'LMENUL89', 'Result Attendance View' );
...
<div id="content_header">
    ...
    <div id="contentHeader">Attendance View For The Section</div>
</div>
<div class="clear"></div>
<div class="display">
        	...
        	<table width="100%" align="left" border = "0" class="buttons" id="mainTable">
                ...
                <?php 
                	...
                	foreach ($candidateIds as $candidateId){
                		...
                		$details = $result->getTableIdDetails($attendance[0]);
                		echo "
