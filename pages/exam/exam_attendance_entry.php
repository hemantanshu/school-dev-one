...
$body->startBody ( 'exam', 'LMENUL87', 'Result Attendance Submission' );
...
$enteredCandidates = $result->getCandidate4Data($resultSectionId, 'ATTND');
        	...
        	<table width="100%" align="left" border = "0" class="buttons" id="mainTable">
                ...
                <?php 
                	...
                	foreach ($candidateIds as $candidateId){
                		...
                		$attendance = $result->getCandidateData($resultSectionId, $candidateId, 'ATTND');
                		...
                		echo "
                			<tr class=\"odd\" id=\"$tableId\">
			                    ...
			                    <th>".$gender."</th>
			                    <th><input type=\"text\" id=\"".$markId."\" name=\"".$markId."\" size=\"10\" value=\"".$attendance[1]."\"/></th>
			                    <th><button type=\"button\" class=\"negative insert\" onclick=\"processConfirmAction('".$candidateId."')\">Submit & Confirm</th>
			                </tr>";
                		++$i;
                	}
                ?>
