...
$body->startBody ( 'exam', 'LMENUL78', 'Exam Mark Submission');
...
$candidateIds = $marks->getCandidate4MarkSubmission($examinationId);
$markSubmitted = $marks->getMarkSubmittedCandidateIds($examinationId, false);
$markCofirmed = $marks->getMarkSubmittedCandidateIds($examinationId, true);
?>
