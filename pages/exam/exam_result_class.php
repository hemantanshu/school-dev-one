...
$body->startBody ( 'exam', 'LMENUL100', 'Examination Class Assignment' );
...
$assignmentIds = $options->getAssignmentIds($resultId, 'CLSSA', 1);
...
?>
<input type="hidden" value="<?php echo $resultId; ?>"
...
<div id="content_header">
	...
	<div id="contentHeader">Result Class Assignment Form</div>
</div>
<div class="clear"></div>
<div class="display">
	<div id="displaySubjectRecord">
		<fieldset class="displayElements">
			<dl>
				...
				<dd style="width: 30%">
					<span id="resultName"><?php echo $details['result_name']; ?></span>
				</dd>
				<dt style="width: 15%">
...
<div class="display">
	<div id="displayRecord" style="display: none">
		<fieldset class="displayElements">
			<div class="legend">
				<span id="legendDisplayAssignment">Result Class Details : </span>
			</div>
			<dl>
				<dt style="width: 15%;">
...
<div id="displayDatatable" class="buttons">
	<div class="datatable" id="groupMenusM">
		<fieldset>
			<div class="legend">
				<span>Result Class-Section Assignment</span>
			</div>
