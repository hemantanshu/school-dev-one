...
$body = new body();
$options = new options();
$body->startBody('global', 'LMENUL99', 'Option Value Assignment');

$optionType = $_GET['optionTypeId'];
$optionValue = $_GET['optionValueId'];
...
<div id="content_header">
    ...
    <div id="contentHeader"><?php echo $details['comments'] . "" . $options->getOptionIdValue($optionValue); ?> </div>
</div>
