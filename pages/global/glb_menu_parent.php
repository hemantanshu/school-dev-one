            ...
            <fieldset class="formelements">
                ...
                <dl class="element">
                    ...
                    <dd style="width: 80%">
                        ...
                        <input type="text" size="40" name="parentMenu" id="parentMenu" class="required autocomplete" onblur="getInsertMenuDetails()" tabindex="1" onchange="javascript: valid.validateInput(this);" title="" />
