            ...
            <fieldset class="formelements">
                ...
                <dl class="element">
                    ...
                    <dd style="width: 80%">
                        ...
                        <input type="text" size="30" name="parentMenu" id="parentMenu" class="required" onblur="getInsertMenuDetails()" tabindex="1" onchange="javascript: valid.validateInput(this);" title="" />
