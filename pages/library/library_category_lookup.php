...
$body = new body ();
$body->startBody ( 'global', 'LMENUL9', 'Library Item Category Lookup', 'LMENUL136' );
?>
<input type="hidden" value="LICAT" name="optionType_glb"
	id="optionType_glb" />
<div id="content_header">
    ...
    <div id="contentHeader">Item Category Record Details Form</div>
</div>
<div class="inputs">
    <form id="insertForm" class="insertForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span>New Category Record Entry Form</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
                    <label for="valueName">Item Category :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="inputs">
    <form id="updateForm" class="updateForm"
        ...
        <fieldset class="formelements">
            <div class="legend">
                <span id="legend_updateForm">Category Record Update Form </span>
            </div>
            <dl class="element">
                <dt style="width: 15%">

                    <label for="valueName_u">Item Category :</label>
                </dt>
                <dd style="width: 35%">
...
<div class="display">
    <div id="displayValue">
        <fieldset class="displayElements">
            <div class="legend">
                <span id="legendDisplayAssignment">Category Details : </span>
            </div>
            <dl>
                <dt style="width: 15%">
                    <label for="optionId">Category Id : </label>
                </dt>
                <dd style="width: 30%">
            ...
            <dl>
                <dt style="width: 15%;">
                    <label for="valueName_d">Item Category : </label>
                </dt>
                <dd style="width: 30%">
...
<div class="inputs">
    <form id="searchForm" class="searchForm"
        ...
        <fieldset class="formelements">
            <div class="legend">Search Item Category</div>
            <dl>
                <dt style="width: 15%">
                    <label for="menu_hint">Item Category :</label>
                </dt>
                <dd style="width: 30%">
                    <input type="text" name="menu_hint" id="menu_hint" class=""
                           style="width: 200px" title="Enter The Item Category" />
                </dd>
                <dt style="width: 10%">
                ...
                <dd>
                    <select name="search_type" id="search_type" style="width: 150px">
                        <option value="all">All Item Category</option>
                        <option value="1" selected="selected">Active Item Category</option>
                        <option value="0">In-Active Item Category</option>
                    </select>
                </dd>
            </dl>
        </fieldset>
...
<div id="displayDatatable" class="buttons">
    <div class="datatable" id="groupMenusM">
        <fieldset>
            <div class="legend">
                <span>Category Record Tabluated Listing</span>
            </div>
            <table  class="display"
                   id="groupValues">
                <thead>
