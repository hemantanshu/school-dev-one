...
$body = new body ();
$body->startBody ( 'library', 'LMENUL141', 'Library Vendor Category Managment' );
...
<div id="content_header">
    ...
    <div id="contentHeader">Vendor Category Entry </div>
</div>
<div class="clear"></div>
<div class="display">
...
<div class="inputs">
    <form id="insertForm" class="insertForm" onsubmit="return valid.validateForm(this) ? processInsertForm() : false;">
        <fieldset class="formelements">
            <div class="legend">
                <span>New Category For The Vendor</span>
            </div>
            <dl class="element">
                <dt style="width: 15%">
                ...
                <dd style="width: 30%">
                    ...
                    <input type="text" name="category" id="category" class="required autocomplete"  title="Category Of The Vendor"  tabindex="1" value="" size="40" onchange="javascript: valid.validateInput(this);" />
...
<div class="display">
    <div id="displayRecord" style="display:none">
        <fieldset class="displayElements">
            <div class="legend">
                <span>Details Of The Vendor Category</span>
            </div>
            <dl>
                <dt style="width: 15%;">
                    <label for="categoryDisplay">Category Name :</label>
                </dt>
                <dd style="width: 30%">
...
<div class="datatable buttons" id="displayDatatable" style="display:none">
    <fieldset class="formelements">
        <div class="legend">
            <span>Tabulated Listing Of All Categories</span>
        </div>
        <table  class="display"
               id="groupRecords">
            <thead>
