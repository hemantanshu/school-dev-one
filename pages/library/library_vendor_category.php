        ...
        <fieldset class="formelements">
            ...
            <dl class="element">
                ...
                <dd style="width: 30%">
                    ...
                    <input type="text" name="category" id="category" class="required autocomplete"  title="Category Of The Vendor"  tabindex="1" value="" size="30" onchange="javascript: valid.validateInput(this);" />
