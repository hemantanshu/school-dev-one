...
function processConfirmAction(candidateId){
    var rowId = "table"+candidateId;
    var markId = "mark"+candidateId;
    var mark = $('#'+markId).val();
    showLoading("Uploading Data To Server");
    var data = 'task=confirmAttendance&attendance='+mark+'&resultSectionId='+resultSectionId+'&candidateId='+candidateId;
    $
        .ajax({
            url:formGlobalPath + "exam/exam_result_attendance_form.php",
            type:"POST",
            data:data,
            cache:false,
            dataType:'json',
