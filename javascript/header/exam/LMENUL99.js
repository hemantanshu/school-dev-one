...
var examinationId, formGlobalPath, oTable;
$(document)
    .ready(
    function () {
...
// preparing for ajax call
    ...
    data = 'examinationId='+examinationId+'&task=insertRecord&' + data;
    showLoading("Uploading Data To Server");
    $
        .ajax({
            url:formGlobalPath + "exam/exam_examination_class_form.php",
            type:"POST",
            data:data,
            cache:false,
            dataType:'json',
...
function getSearchResults() {
    ...
    data = 'examinationId='+examinationId+'&task=search&' + data;
