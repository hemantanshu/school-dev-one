...
function showHidePersonalForm() {
    toggleTheDiv('candidateInfo');
}
...
function processInsertForm() {
    ...
    data = 'candidateId=' + candidateId + '&task=insertRecord&' + data;
...
function getSearchDetails() {
    ...
    data = 'candidateId=' + candidateId + '&task=searchDetails&' + data;
    showLoading("Fetching Data From Server");
    $
        .ajax({
            url:formGlobalPath + "utility/utl_candidate_education_form.php",
...
function dropRecord(id, aPos) {
    if (confirm('Do you really want to delete ?')) {
        ...
        $
            .ajax({
                url:formGlobalPath
                    + "utility/utl_candidate_education_form.php",
                type:"POST",
                data:data,
                cache:false,
                dataType:'json',
