...
function loadGuardianDetails() {
    ...
    data = 'candidateId=' + candidateId + '&guardianType=' + guardianType + '&task=fetchGuardianRecord';
    $
        .ajax({
            url:formGlobalPath + "utility/utl_candidate_gaurdian_form.php",
            type:"POST",
...
function loadGuardianAddressDetails() {
    ...
    data = 'candidateId=' + candidateId + '&guardianType=' + guardianType + '&task=fetchAddress';
    $
        .ajax({
            url:formGlobalPath + "utility/utl_candidate_gaurdian_form.php",
            type:"POST",
...
function processUpdateForm() {
    ...
    data = 'candidateId=' + candidateId + '&guardianType=' + guardianType + '&task=updateRecord&' + data;
    showLoading("Fetching Data From Server");
    $
        .ajax({
            url:formGlobalPath + "utility/utl_candidate_gaurdian_form.php",
            ...
            success:function (output) {
                checkValidityOfOutput(output);
                if (output[0] != 0) {
                    alert('Candidate guardian details has been successfully updated');
