...
$(document)
    ...
    function () {
        ...
        sectionGlobal = $('#section_global').val();

        getClassSectionSessionDetails();
        getSearchResults();
    });
...
function getClassSectionSessionDetails(){
    var data = $('#insertForm').serialize();
    data = 'sectionId=' + sectionGlobal + '&task=getSectionSessionDetails';
    $
        .ajax({
...
function getSearchResults() {
    ...
    data = 'sectionId=' + sectionGlobal + '&task=searchSection&' + data;
...
function bulkSubjectEntry(){
    var link = serverUrl+'pages/utility/utl_class_section_candidate_subject_view.php?sectionId='+sectionGlobal;
    loadPageIntoDisplay(link);
    return false;
}