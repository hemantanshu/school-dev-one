...
function editRecord(id, aPos) {
    ...
    $.ajax({
        ...
        success:function (data) {
            checkValidityOfOutput(data);
            if (data[0] != 0) {
                $('#bankName_u').val(data[1]);
                $('#branchName_u').val(data[2]);
                $('#ifscCode_u').val(data[3]);
                $('#micrCode_u').val(data[4]);
            ...
            .ajax({
                ...
                success:function (output) {
                    ...
                    if (output[0] != 0) {
                        ...
                        handleNotification(
                            'Error In Dropping Bank Details ... Try After Sometime',
                            'error');
                        endLoading();
                    }
            ...
            .ajax({
                ...
                success:function (output) {
                    ...
                    if (output[0] != 0) {
                        ...
                        handleNotification(
                            'Error In Activating Bank Details ... Try After Sometime',
                            'error');
                        endLoading();
                    }
