...
function processInsertForm() {
    ...
    $
        .ajax({
            url:formGlobalPath + "accounts/accounts_accounthead_details_form.php",
            type:"POST",
            data:data,
            cache:false,
            dataType:'json',
...
function showRecordDetails(id, aPos) {
    ...
    $.ajax({
        ...
        success:function (data) {
            checkValidityOfOutput(data);
            if (data[0] != 0) {
                $('#accountHeadName_d').html(data[1]);
                $('#accountType_d').html(data[3]);
                $('#displayOrder_d').html(data[9]);
...
function editRecord(id, aPos) {
    ...
    $.ajax({
        ...
        success:function (data) {
            checkValidityOfOutput(data);
            if (data[0] != 0) {
                $('#accountHeadName_u').val(data[1]);
                $('#accountType_u').val(data[2]);
                $('#displayOrder_u').val(data[9]);
                if (data[8] == 'y') {
                    $('#dropRecord_u').show();
                    $('#dropRecord_u')
                        .attr(
            ...
            .ajax({
                ...
                success:function (output) {
                    ...
                    if (output[0] != 0) {
                        ...
                        handleNotification(
                            'Error In Dropping AccountHead Details ... Try After Sometime',
                            'error');
                        endLoading();
                    }
            ...
            .ajax({
                ...
                success:function (output) {
                    ...
                    if (output[0] != 0) {
                        ...
                        handleNotification(
                            'Error In Activating AccountHead Details ... Try After Sometime',
                            'error');
                        endLoading();
                    }
                }
